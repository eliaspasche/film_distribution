 ...
 */
@Component
public class DistributionReportPdfService extends AbstractPdfService
{
     ...
     */
    public DistributionReportPdfService( AppConfig appConfig, FileDownloadService fileDownloadService, FilmDistributionService filmDistributionService )
    {
     ...
     * @param reportingDate
     */
    public void createInvoicePdf( Customer customer, Film film, LocalDate reportingDate )
    {
        ...
        System.out.println();
        System.out.println();
        rawReport.forEach( rep -> {
            System.out.println( "********************************************************" );
            System.out.println( rep.getCustomerId() );
            System.out.println( rep.getFilmName() );
            System.out.println( rep.getPricePerWeek() );
            System.out.println( rep.getAmount() );
        } );

        String headerInput = loadPdfTemplate( "film-header.html" ).orElse( "" );
        String fileInput = loadPdfTemplate( "film-invoice.html" ).orElse( "" );

        Document htmlDocument = createDocumentFromHtmlText( headerInput );
...
//        getElementByDocument( htmlDocument, "costsAmount" ).appendText( NumbersUtil.formatCurrency( costsNet + tax ) );
        ...
        createPdfFile( htmlDocument, "report", "film-base.css" );
    }
