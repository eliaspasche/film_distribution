# Ausgangsdaten einspielen

#### Tabellen leeren (falls benötigt)
...
INSERT INTO film (name, length, age_group_id, price)
VALUES (N'The Lord of the Rings: The Return of the King', 12060,
        (SELECT id FROM age_group WHERE minimum_age = 0), 0.99);

INSERT INTO film (name, length, age_group_id, price)
VALUES (N'The Lord of the Rings: The Fellowship of the Ring', 10680,
        (SELECT id FROM age_group WHERE minimum_age = 12), 0.99);
...
INSERT INTO film (name, length, age_group_id, price)
VALUES (N'Star Wars: Episode V - The Empire Strikes Back', 7440,
        (SELECT id FROM age_group WHERE minimum_age = 18), 0.99);
...
#### Film Kopien anlegen (zwei Kopien pro Film)
